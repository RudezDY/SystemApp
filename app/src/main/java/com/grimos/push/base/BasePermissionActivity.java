...
/**
 * Created by donghui on 2017/9/1.
 */
...
public abstract class BasePermissionActivity extends BaseActivity {
    ...
    protected final int PERMISSIONCODE=1;
     ...
     * @param tel
     */
    protected void callPhone(final String tel) {
        performRequestPermissions("正在申请打电话权限", new String[]{Manifest.permission.CALL_PHONE}
                , PERMISSIONCODE, new PermissionsResultListener() {
                    @Override
                    public void onPermissionGranted() {
                        ToastUtil.show(mActivity,"获取权限成功");
                        ...
                        try {
                            ...
                            Log.e("callPhone_异常",e.toString());
                        }
                    }

                    @Override
                    public void onPermissionDenied() {
                        ToastUtil.show(mActivity,"获取权限失败");
                    }
                });
